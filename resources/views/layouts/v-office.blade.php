...
<html ng-app="App" ng-controller="Ctrl">
  ...
  <div class="container edit-pane" ng-cloak ng-show="edit_cv==1"><!--edit cv panel starts-->
    <div class="container">
      <div class="row">
        <div class="col-md-3 no-padding edit-form-sec">
          <span class="close" ng-click="edit_cv=0"><i class="fa fa-close" aria-hidden="true"></i></span>
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <textarea  class="form-control" id="cv_objective" ng-model="cv_objective" rows="5"></textarea>
            </div>
            <div class="form-group">
              <a class="btn btn-success" href="#" ng-click="edit_cv=0"><span class="fa fa-thumbs-up"></span> Done</a>
            </div>
         </form>
        </div>
      </div>
    </div>
  </div><!--edit cv panel ends here-->
